...
import {GreenhouseCountDisplayComponent} from '../greenhouse-count-display/greenhouse-count-display.component';
import { AvgHumidityComponent } from '../avg-humidity/avg-humidity.component';
import {AvgTemperatureComponent } from '../avg-temperature/avg-temperature.component';
import { AvgSoilMoistureComponent } from '../avg-soil-moisture/avg-soil-moisture.component';
@Component({
    ...
    standalone: true,
    imports: [RowComponent,AvgSoilMoistureComponent,AvgTemperatureComponent,AvgHumidityComponent,GreenhouseCountDisplayComponent, ColComponent, WidgetStatAComponent, TemplateIdDirective, IconDirective, ThemeDirective, DropdownComponent, ButtonDirective, DropdownToggleDirective, DropdownMenuDirective, DropdownItemDirective, RouterLink, DropdownDividerDirective, ChartjsComponent]
})
